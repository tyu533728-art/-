...
const displayItemAlts = {
  ...
  tr: { UCT: 'UCT geniş iç bilezikli, setskur kilitlemeli yataklı rulman', UEL: 'UEL geniş iç bilezikli, eksantrik kilitleme bilezikli yataklı rulman', UK: 'UK adaptör manşonu için konik delikli yataklı rulman', FB: 'FB yastık blok gövdesi', P: 'P yastık blok gövdesi', PA: 'PA dişli tabanlı yastık blok gövdesi', F: 'F dört cıvatalı flanşlı gövde', FL: 'FL iki cıvatalı flanşlı gövde', FC: 'FC merkezlemeli yuvarlak flanşlı gövde', FS: 'FS merkezleme çıkıntılı kare flanşlı gövde', T: 'T gerdirme gövdesi', FU: 'FU rulman yatağı', PH: 'PH rulman yatağı', PBH: 'PBH rulman yatağı' },
  ru: { UCT: 'UCT вставной подшипник с широким внутренним кольцом и фиксацией установочными винтами', UEL: 'UEL вставной подшипник с широким внутренним кольцом и эксцентриковым стопорным кольцом', UK: 'UK вставной подшипник с коническим отверстием для закрепительной втулки', FB: 'FB корпус подшипника на лапах', P: 'P корпус подшипника на лапах', PA: 'PA корпус подшипника на лапах с резьбовым основанием', F: 'F четырехболтовой фланцевый корпус', FL: 'FL двухболтовой фланцевый корпус', FC: 'FC круглый фланцевый корпус с центрирующим пояском', FS: 'FS квадратный фланцевый корпус с центрирующим выступом', T: 'T натяжной корпус', FU: 'FU корпус подшипника', PH: 'PH корпус подшипника', PBH: 'PBH корпус подшипника' },
  it: { UCT: 'UCT cuscinetto inserto con anello interno largo e bloccaggio con grani', UEL: 'UEL cuscinetto inserto con anello interno largo e collare di bloccaggio eccentrico', UK: 'UK cuscinetto inserto con foro conico per bussola di fissaggio', FB: 'FB supporto a piede', P: 'P supporto a piede', PA: 'PA supporto a piede con base filettata', F: 'F supporto flangiato a quattro bulloni', FL: 'FL supporto flangiato a due bulloni', FC: 'FC supporto flangiato rotondo con centraggio', FS: 'FS supporto flangiato quadrato con risalto di centraggio', T: 'T supporto tenditore', FU: 'FU supporto per cuscinetti', PH: 'PH supporto per cuscinetti', PBH: 'PBH supporto per cuscinetti' },
  vi: { UCT: 'UCT vòng bi lắp có vòng trong rộng, khóa bằng vít chặn', UEL: 'UEL vòng bi lắp có vòng trong rộng, khóa bằng vòng lệch tâm', UK: 'UK vòng bi lắp có lỗ côn cho ống lót chặn', FB: 'FB gối đỡ chân đế', P: 'P gối đỡ chân đế', PA: 'PA gối đỡ chân đế có đế ren', F: 'F gối đỡ mặt bích bốn bu lông', FL: 'FL gối đỡ mặt bích hai bu lông', FC: 'FC gối đỡ mặt bích tròn có gờ định tâm', FS: 'FS gối đỡ mặt bích vuông có gờ định tâm', T: 'T gối đỡ tăng đơ', FU: 'FU gối đỡ vòng bi', PH: 'PH gối đỡ vòng bi', PBH: 'PBH gối đỡ vòng bi' },
  ...
  ja: { UCT: 'UCT 広幅内輪付き止めねじ固定インサート軸受', UEL: 'UEL 広幅内輪付き偏心ロックカラー固定インサート軸受', UK: 'UK アダプタスリーブ用テーパ穴付きインサート軸受', FB: 'FB ピローブロックハウジング', P: 'P ピローブロックハウジング', PA: 'PA ねじ込みベース付きピローブロックハウジング', F: 'F 4ボルトフランジハウジング', FL: 'FL 2ボルトフランジハウジング', FC: 'FC センタリング付き丸形フランジハウジング', FS: 'FS センタリング突起付き角形フランジハウジング', T: 'T テークアップハウジング', FU: 'FU ベアリングハウジング', PH: 'PH ベアリングハウジング', PBH: 'PBH ベアリングハウジング' },
  ko: { UCT: 'UCT 넓은 내륜 세트스크루 잠금 인서트 베어링', UEL: 'UEL 넓은 내륜 편심 잠금 칼라 인서트 베어링', UK: 'UK 어댑터 슬리브용 테이퍼 보어 인서트 베어링', FB: 'FB 필로우 블록 하우징', P: 'P 필로우 블록 하우징', PA: 'PA 나사식 베이스 필로우 블록 하우징', F: 'F 4볼트 플랜지 하우징', FL: 'FL 2볼트 플랜지 하우징', FC: 'FC 센터링 원형 플랜지 하우징', FS: 'FS 센터링 돌출부가 있는 사각 플랜지 하우징', T: 'T 테이크업 하우징', FU: 'FU 베어링 하우징', PH: 'PH 베어링 하우징', PBH: 'PBH 베어링 하우징' }
};
...
function housingImageCards(locale, badgeCodes = false) {
  ...
  const confirmedCodes = new Set(['FB', 'FL', 'P', 'T', 'F', 'PBH', 'FC', 'FU', 'PH', 'PA']);
