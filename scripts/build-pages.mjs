...
const displayItemAlts = {
  ...
  tr: { UCT: 'UCT geniş iç bilezikli, setskur kilitlemeli yataklı rulman', UEL: 'UEL geniş iç bilezikli, eksantrik kilitleme bilezikli yataklı rulman', UK: 'UK adaptör manşonu için konik delikli yataklı rulman', FB: 'FB yastık blok gövdesi', PA: 'PA dişli tabanlı yastık blok gövdesi', F: 'F dört cıvatalı flanşlı gövde', FL: 'FL iki cıvatalı flanşlı gövde', FC: 'FC merkezlemeli yuvarlak flanşlı gövde', FS: 'FS merkezleme çıkıntılı kare flanşlı gövde', T: 'T gerdirme gövdesi' },
  ru: { UCT: 'UCT вставной подшипник с широким внутренним кольцом и фиксацией установочными винтами', UEL: 'UEL вставной подшипник с широким внутренним кольцом и эксцентриковым стопорным кольцом', UK: 'UK вставной подшипник с коническим отверстием для закрепительной втулки', FB: 'FB корпус подшипника на лапах', PA: 'PA корпус подшипника на лапах с резьбовым основанием', F: 'F четырехболтовой фланцевый корпус', FL: 'FL двухболтовой фланцевый корпус', FC: 'FC круглый фланцевый корпус с центрирующим пояском', FS: 'FS квадратный фланцевый корпус с центрирующим выступом', T: 'T натяжной корпус' },
  it: { UCT: 'UCT cuscinetto inserto con anello interno largo e bloccaggio con grani', UEL: 'UEL cuscinetto inserto con anello interno largo e collare di bloccaggio eccentrico', UK: 'UK cuscinetto inserto con foro conico per bussola di fissaggio', FB: 'FB supporto a piede', PA: 'PA supporto a piede con base filettata', F: 'F supporto flangiato a quattro bulloni', FL: 'FL supporto flangiato a due bulloni', FC: 'FC supporto flangiato rotondo con centraggio', FS: 'FS supporto flangiato quadrato con risalto di centraggio', T: 'T supporto tenditore' },
  vi: { UCT: 'UCT vòng bi lắp có vòng trong rộng, khóa bằng vít chặn', UEL: 'UEL vòng bi lắp có vòng trong rộng, khóa bằng vòng lệch tâm', UK: 'UK vòng bi lắp có lỗ côn cho ống lót chặn', FB: 'FB gối đỡ chân đế', PA: 'PA gối đỡ chân đế có đế ren', F: 'F gối đỡ mặt bích bốn bu lông', FL: 'FL gối đỡ mặt bích hai bu lông', FC: 'FC gối đỡ mặt bích tròn có gờ định tâm', FS: 'FS gối đỡ mặt bích vuông có gờ định tâm', T: 'T gối đỡ tăng đơ' },
  id: { UCT: 'UCT bantalan sisip cincin dalam lebar dengan penguncian baut penyetel', UEL: 'UEL bantalan sisip cincin dalam lebar dengan cincin pengunci eksentrik', UK: 'UK bantalan sisip berlubang tirus untuk selongsong adaptor', FB: 'FB rumah bantalan duduk', PA: 'PA rumah bantalan duduk dengan alas berulir', F: 'F rumah bantalan flens empat baut', FL: 'FL rumah bantalan flens dua baut', FC: 'FC rumah bantalan flens bundar dengan pemandu', FS: 'FS rumah bantalan flens persegi dengan tonjolan pemandu', T: 'T rumah bantalan penegang' },
  ja: { UCT: 'UCT 広幅内輪付き止めねじ固定インサート軸受', UEL: 'UEL 広幅内輪付き偏心ロックカラー固定インサート軸受', UK: 'UK アダプタスリーブ用テーパ穴付きインサート軸受', FB: 'FB ピローブロックハウジング', PA: 'PA ねじ込みベース付きピローブロックハウジング', F: 'F 4ボルトフランジハウジング', FL: 'FL 2ボルトフランジハウジング', FC: 'FC センタリング付き丸形フランジハウジング', FS: 'FS センタリング突起付き角形フランジハウジング', T: 'T テークアップハウジング' },
  ko: { UCT: 'UCT 넓은 내륜 세트스크루 잠금 인서트 베어링', UEL: 'UEL 넓은 내륜 편심 잠금 칼라 인서트 베어링', UK: 'UK 어댑터 슬리브용 테이퍼 보어 인서트 베어링', FB: 'FB 필로우 블록 하우징', PA: 'PA 나사식 베이스 필로우 블록 하우징', F: 'F 4볼트 플랜지 하우징', FL: 'FL 2볼트 플랜지 하우징', FC: 'FC 센터링 원형 플랜지 하우징', FS: 'FS 센터링 돌출부가 있는 사각 플랜지 하우징', T: 'T 테이크업 하우징' }
};
