...
const displayItemAlts = {
  en: { UCT: 'UCT wide inner ring insert bearing, set-screw locking', UEL: 'UEL wide inner ring insert bearing, eccentric locking collar', UK: 'UK insert bearing, tapered bore for adapter sleeve', UCPA: 'UCPA tapped-base pillow block unit with insert bearing', UCF: 'UCF four-bolt flanged unit with insert bearing', UCFC: 'UCFC piloted round flanged unit with insert bearing', UCFL: 'UCFL two-bolt flanged unit with insert bearing', UCP: 'UCP pillow block unit with insert bearing', UCPH: 'UCPH pillow block unit with long shaft and insert bearing', UCFA: 'UCFA flanged unit with insert bearing', UCFB: 'UCFB flanged unit with insert bearing', PBU: 'PBU pillow block bearing unit with insert bearing', MBU: 'MBU mounted bearing unit with insert bearing', FB: 'FB pillow block housing', P: 'P pillow block housing', PA: 'PA tapped-base pillow block housing', PAS: 'PAS bearing housing', F: 'F four-bolt flanged housing', FL: 'FL two-bolt flanged housing', FC: 'FC piloted round flanged housing', FS: 'FS square flange with spigot housing', T: 'T take-up housing', FU: 'FU bearing housing', PH: 'PH bearing housing', PBH: 'PBH bearing housing' },
  es: { UCT: 'UCT rodamiento insertable de aro interior ancho con fijación por tornillos prisioneros', UEL: 'UEL rodamiento insertable de aro interior ancho con collarín excéntrico de fijación', UK: 'UK rodamiento insertable con agujero cónico para manguito de fijación', FB: 'FB soporte de pie', P: 'P soporte de pie', PA: 'PA soporte de pie con base roscada', PAS: 'PAS soporte de rodamiento', F: 'F soporte con brida de cuatro pernos', FL: 'FL soporte con brida de dos pernos', FC: 'FC soporte con brida circular centradora', FS: 'FS soporte con brida cuadrada y resalte de centrado', T: 'T soporte tensor', FU: 'FU soporte de rodamiento', PH: 'PH soporte de rodamiento', PBH: 'PBH soporte de rodamiento' },
  de: { UCT: 'UCT Pendellager mit breitem Innenring und Gewindestiftbefestigung', UEL: 'UEL Pendellager mit breitem Innenring und Exzenterringbefestigung', UK: 'UK Pendellager mit Kegelbohrung für Spannhülse', FB: 'FB Stehlagergehäuse', P: 'P Stehlagergehäuse', PA: 'PA Stehlagergehäuse mit Gewindesockel', PAS: 'PAS Lagergehäuse', F: 'F Vierloch-Flanschlagergehäuse', FL: 'FL Zweiloch-Flanschlagergehäuse', FC: 'FC rundes Flanschlagergehäuse mit Zentrierbund', FS: 'FS quadratisches Flanschlagergehäuse mit Zentrierbund', T: 'T Spannlagergehäuse', FU: 'FU Lagergehäuse', PH: 'PH Lagergehäuse', PBH: 'PBH Lagergehäuse' },
  fr: { UCT: 'UCT roulement insert à bague intérieure large avec blocage par vis de pression', UEL: 'UEL roulement insert à bague intérieure large avec collier de blocage excentrique', UK: 'UK roulement insert à alésage conique pour manchon de serrage', FB: 'FB palier semelle', P: 'P palier semelle', PA: 'PA palier semelle à base taraudée', PAS: 'PAS palier', F: 'F palier à bride à quatre boulons', FL: 'FL palier à bride à deux boulons', FC: 'FC palier à bride ronde avec centrage', FS: 'FS palier à bride carrée avec épaulement de centrage', T: 'T palier tendeur', FU: 'FU palier', PH: 'PH palier', PBH: 'PBH palier' },
  pt: { UCT: 'UCT rolamento inserto de anel interno largo com fixação por parafusos de pressão', UEL: 'UEL rolamento inserto de anel interno largo com colar de travamento excêntrico', UK: 'UK rolamento inserto com furo cônico para bucha de fixação', FB: 'FB mancal de base', P: 'P mancal de base', PA: 'PA mancal de base roscada', PAS: 'PAS mancal', F: 'F mancal flangeado de quatro parafusos', FL: 'FL mancal flangeado de dois parafusos', FC: 'FC mancal flangeado redondo com centragem', FS: 'FS mancal flangeado quadrado com ressalto de centragem', T: 'T mancal tensor', FU: 'FU mancal', PH: 'PH mancal', PBH: 'PBH mancal' },
  ar: { UCT: 'UCT محمل إدخالي بحلقة داخلية عريضة وتثبيت بمسامير ضبط', UEL: 'UEL محمل إدخالي بحلقة داخلية عريضة وطوق تثبيت لامركزي', UK: 'UK محمل إدخالي بثقب مخروطي لجلبة تثبيت', FB: 'FB هيكل محمل قائم', P: 'P هيكل محمل قائم', PA: 'PA هيكل محمل قائم بقاعدة ملولبة', PAS: 'PAS بيت محمل', F: 'F هيكل محمل بشفة بأربعة مسامير', FL: 'FL هيكل محمل بشفة بمسمارين', FC: 'FC هيكل محمل دائري بشفة مع تمركز', FS: 'FS هيكل محمل بشفة مربعة مع بروز تمركز', T: 'T هيكل محمل شداد', FU: 'FU بيت محمل', PH: 'PH بيت محمل', PBH: 'PBH بيت محمل' },
  tr: { UCT: 'UCT geniş iç bilezikli, setskur kilitlemeli yataklı rulman', UEL: 'UEL geniş iç bilezikli, eksantrik kilitleme bilezikli yataklı rulman', UK: 'UK adaptör manşonu için konik delikli yataklı rulman', FB: 'FB yastık blok gövdesi', P: 'P yastık blok gövdesi', PA: 'PA dişli tabanlı yastık blok gövdesi', PAS: 'PAS rulman yatağı', F: 'F dört cıvatalı flanşlı gövde', FL: 'FL iki cıvatalı flanşlı gövde', FC: 'FC merkezlemeli yuvarlak flanşlı gövde', FS: 'FS merkezleme çıkıntılı kare flanşlı gövde', T: 'T gerdirme gövdesi', FU: 'FU rulman yatağı', PH: 'PH rulman yatağı', PBH: 'PBH rulman yatağı' },
  ru: { UCT: 'UCT вставной подшипник с широким внутренним кольцом и фиксацией установочными винтами', UEL: 'UEL вставной подшипник с широким внутренним кольцом и эксцентриковым стопорным кольцом', UK: 'UK вставной подшипник с коническим отверстием для закрепительной втулки', FB: 'FB корпус подшипника на лапах', P: 'P корпус подшипника на лапах', PA: 'PA корпус подшипника на лапах с резьбовым основанием', PAS: 'PAS корпус подшипника', F: 'F четырехболтовой фланцевый корпус', FL: 'FL двухболтовой фланцевый корпус', FC: 'FC круглый фланцевый корпус с центрирующим пояском', FS: 'FS квадратный фланцевый корпус с центрирующим выступом', T: 'T натяжной корпус', FU: 'FU корпус подшипника', PH: 'PH корпус подшипника', PBH: 'PBH корпус подшипника' },
  it: { UCT: 'UCT cuscinetto inserto con anello interno largo e bloccaggio con grani', UEL: 'UEL cuscinetto inserto con anello interno largo e collare di bloccaggio eccentrico', UK: 'UK cuscinetto inserto con foro conico per bussola di fissaggio', FB: 'FB supporto a piede', P: 'P supporto a piede', PA: 'PA supporto a piede con base filettata', PAS: 'PAS supporto per cuscinetti', F: 'F supporto flangiato a quattro bulloni', FL: 'FL supporto flangiato a due bulloni', FC: 'FC supporto flangiato rotondo con centraggio', FS: 'FS supporto flangiato quadrato con risalto di centraggio', T: 'T supporto tenditore', FU: 'FU supporto per cuscinetti', PH: 'PH supporto per cuscinetti', PBH: 'PBH supporto per cuscinetti' },
  vi: { UCT: 'UCT vòng bi lắp có vòng trong rộng, khóa bằng vít chặn', UEL: 'UEL vòng bi lắp có vòng trong rộng, khóa bằng vòng lệch tâm', UK: 'UK vòng bi lắp có lỗ côn cho ống lót chặn', FB: 'FB gối đỡ chân đế', P: 'P gối đỡ chân đế', PA: 'PA gối đỡ chân đế có đế ren', PAS: 'PAS gối đỡ vòng bi', F: 'F gối đỡ mặt bích bốn bu lông', FL: 'FL gối đỡ mặt bích hai bu lông', FC: 'FC gối đỡ mặt bích tròn có gờ định tâm', FS: 'FS gối đỡ mặt bích vuông có gờ định tâm', T: 'T gối đỡ tăng đơ', FU: 'FU gối đỡ vòng bi', PH: 'PH gối đỡ vòng bi', PBH: 'PBH gối đỡ vòng bi' },
  id: { UCT: 'UCT bantalan sisip cincin dalam lebar dengan penguncian baut penyetel', UEL: 'UEL bantalan sisip cincin dalam lebar dengan cincin pengunci eksentrik', UK: 'UK bantalan sisip berlubang tirus untuk selongsong adaptor', FB: 'FB rumah bantalan duduk', P: 'P rumah bantalan duduk', PA: 'PA rumah bantalan duduk dengan alas berulir', PAS: 'PAS rumah bantalan', F: 'F rumah bantalan flens empat baut', FL: 'FL rumah bantalan flens dua baut', FC: 'FC rumah bantalan flens bundar dengan pemandu', FS: 'FS rumah bantalan flens persegi dengan tonjolan pemandu', T: 'T rumah bantalan penegang', FU: 'FU rumah bantalan', PH: 'PH rumah bantalan', PBH: 'PBH rumah bantalan' },
  ja: { UCT: 'UCT 広幅内輪付き止めねじ固定インサート軸受', UEL: 'UEL 広幅内輪付き偏心ロックカラー固定インサート軸受', UK: 'UK アダプタスリーブ用テーパ穴付きインサート軸受', FB: 'FB ピローブロックハウジング', P: 'P ピローブロックハウジング', PA: 'PA ねじ込みベース付きピローブロックハウジング', PAS: 'PAS ベアリングハウジング', F: 'F 4ボルトフランジハウジング', FL: 'FL 2ボルトフランジハウジング', FC: 'FC センタリング付き丸形フランジハウジング', FS: 'FS センタリング突起付き角形フランジハウジング', T: 'T テークアップハウジング', FU: 'FU ベアリングハウジング', PH: 'PH ベアリングハウジング', PBH: 'PBH ベアリングハウジング' },
  ko: { UCT: 'UCT 넓은 내륜 세트스크루 잠금 인서트 베어링', UEL: 'UEL 넓은 내륜 편심 잠금 칼라 인서트 베어링', UK: 'UK 어댑터 슬리브용 테이퍼 보어 인서트 베어링', FB: 'FB 필로우 블록 하우징', P: 'P 필로우 블록 하우징', PA: 'PA 나사식 베이스 필로우 블록 하우징', PAS: 'PAS 베어링 하우징', F: 'F 4볼트 플랜지 하우징', FL: 'FL 2볼트 플랜지 하우징', FC: 'FC 센터링 원형 플랜지 하우징', FS: 'FS 센터링 돌출부가 있는 사각 플랜지 하우징', T: 'T 테이크업 하우징', FU: 'FU 베어링 하우징', PH: 'PH 베어링 하우징', PBH: 'PBH 베어링 하우징' }
};
...
function seriesStructureSentence(locale, series) {
  const table = seriesStructureText[locale] ?? seriesStructureText.en;
  const key = SERIES_STRUCTURE_KEY[series.seriesCode];
