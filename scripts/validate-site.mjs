...
const expectedPublicImages = ['uct-product.webp', 'uc-product.webp', 'ucpa-unit.webp', 'ucf-unit.webp', 'ucfc-unit.webp', 'ucfl-unit.webp', 'ucp-unit.webp', 'ucph-unit.webp', 'ucfa-unit.webp', 'ucfb-unit.webp', 'pbu-unit.webp', 'mbu-unit.webp', 'housing-1.webp', 'housing-2.webp', 'housing-3.webp', 'housing-4.webp', 'housing-5.webp'];
if (JSON.stringify(publicProductImages.sort()) !== JSON.stringify(expectedPublicImages.sort())) fail('assets/product-images must contain exactly the 17 active images');
...
try {
  ...
  if (JSON.stringify(distImages.sort()) !== JSON.stringify(expectedPublicImages.sort())) fail('dist must deploy exactly the 17 active product images');
