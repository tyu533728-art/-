...
/** Guides 栏目（仅英文） */
const guideRoutes = ['guides', ...['ucp-vs-ucf-vs-ucfl-which-housing', 'why-housing-bore-tolerance-matters', 'how-to-read-a-bearing-housing-model-number', 'how-to-choose-bearing-housing-material', 'bearing-lubrication-basics', 'bearing-housing-mounting-types'].map(slug => `guides/${slug}`), 'privacy', 'terms']
...
for (const [route, html] of localizedHtml) {
  ...
  if (parts[1] === 'guides' || parts[1] === 'privacy' || parts[1] === 'terms') {
