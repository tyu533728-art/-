...
for (const [route, html] of localizedHtml) {
  ...
  if (seriesRoute) {
    ...
    const expectedH1 = `${seriesRoute.code} ${seriesWord[locale]}`;
...
const expectedPublicImages = ['uc-product.webp', 'ucpa-unit.webp', 'ucf-unit.webp', 'ucfc-unit.webp', 'ucfl-unit.webp', 'ucp-unit.webp', 'p-housing.webp', 'pa-housing.webp', 'f-housing.webp', 'fl-housing.webp', 'fc-housing.webp', 'fs-housing.webp', 't-housing.webp'];
if (JSON.stringify(publicProductImages.sort()) !== JSON.stringify(expectedPublicImages.sort())) fail('assets/product-images must contain exactly the 13 active images');
...
try {
  ...
  if (JSON.stringify(distImages.sort()) !== JSON.stringify(expectedPublicImages.sort())) fail('dist must deploy exactly the 13 active product images');
