...
const expectedPublicImages = ['uc-product.webp', 'p-housing.webp', 'pa-housing.webp', 'f-housing.webp', 'fl-housing.webp', 'fc-housing.webp', 'fs-housing.webp', 't-housing.webp'];
if (JSON.stringify(publicProductImages.sort()) !== JSON.stringify(expectedPublicImages.sort())) fail('assets/product-images must contain exactly the 8 active images');
...
try {
  ...
  if (JSON.stringify(distImages.sort()) !== JSON.stringify(expectedPublicImages.sort())) fail('dist must deploy exactly the 8 active product images');
