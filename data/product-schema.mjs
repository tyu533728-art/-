...
export const SERIES_BY_CATEGORY = Object.freeze({
  'Pillow Block Bearing Units': ['UCT', 'UEL', 'UK', 'UCPA', 'UCF', 'UCFC', 'UCFL', 'UCP', 'UCPH', 'UCFA', 'UCFB'],
  'Bearing Housing Series': ['P', 'PA', 'F', 'FL', 'FC', 'FS', 'T'],
  Custom: []
});

export const ACTIVE_SERIES = ['UCT', 'UCPA', 'UCF', 'UCFC', 'UCFL', 'UCP', 'UCPH', 'UCFA', 'UCFB', 'P', 'PA', 'F', 'FL', 'FC', 'FS', 'T'];
