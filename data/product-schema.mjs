...
export const SERIES_BY_CATEGORY = Object.freeze({
  ...
  'Bearing Housing Series': ['FB', 'FL', 'P', 'T', 'F', 'FC', 'FU', 'PH', 'PA', 'FS'],
  Custom: []
});

export const ACTIVE_SERIES = ['UCT', 'UCPA', 'UCF', 'UCFC', 'UCFL', 'UCP', 'UCPH', 'UCFA', 'UCFB', 'PBU', 'MBU', 'UC', 'FB', 'FL', 'P', 'T', 'F', 'FC', 'FU', 'PH', 'PA'];
